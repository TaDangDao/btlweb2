...
function signUp(form) {
    ...
    var listUser = getListUser()||UserInfo;
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">SmartPhone Store</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">Group 14th</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giao hàng nhanh chóng, tiết kiệm</li>
